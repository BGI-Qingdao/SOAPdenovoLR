...
void copyEdge ( unsigned int source, unsigned int target )
{
	...
	edge_array[target].type = edge_array[source].type;
	edge_array[target].inbubble = edge_array[source].inbubble;
	edge_array[target].in_path = edge_array[source].in_path;
	...
	edge_array[target].rv = edge_array[source].rv;
	edge_array[source].rv = NULL;
