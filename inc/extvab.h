...
extern long long pathCount;
extern long long nodeCount;     // number of edges in read path
extern int maxPathLen;          // max edge number of read path
/**** used for contiging ****/
extern boolean repeatSolve;     //whether solve repeat or not
extern boolean newRepeatSolve;  // whether solve repeat using new stragegy
extern long long cvgAvg4Edge;
extern long long cvgAvg4NoneCvg1Edge;   // average coverag of edges with coverage larger than 1
extern boolean repsTie;
extern boolean repsYali;
...
extern READPATH *readPath;      // read path consisting of at least three edges
extern unsigned int *edgesInReadPaths;   // edges in read paths
/***** used for scaffolding *****/
extern MEM_MANAGER * cn_mem_manager;
extern unsigned int num_ctg;
extern unsigned int * index_array;
extern unsigned int * swapped_index_array;
