...
extern void ClassifyEdges ();
extern void BubbleStat ();
extern void setRtype(unsigned int edge_num);
extern void setType(unsigned int edge_num);
...
extern void buildReverseComplementEdge ( unsigned int edgeno );
...
extern ARC *arcCounts (unsigned int edgeid, unsigned int *num);
...
extern unsigned int removeWeakArcEdges (int lenCutoff, unsigned int multiCutoff);
extern unsigned int removeMinorArc (unsigned int multiCutoff, float rateCutoff);
extern ARC * arcCount ( unsigned int edgeid, unsigned int * num );
extern void mapFileTrans ( char * infile );
extern void solveReps();
extern void parseReadPaths (char *graphfile, double cvg_cutoff_cef, int path_weight_cutoff, int linkHete);
...
extern boolean loadPathBinLR (char *graphfile, double cvg_cutoff_cef, int path_weight_cutoff);
