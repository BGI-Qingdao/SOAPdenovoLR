...
unsigned int * swapped_index_array = NULL; // used to record the new contig index after swapping and sorting in contig step
...
boolean repsTie = 0;            //solve tiny repeat or not
boolean repsYali = 0;		//solve repeat with new strategy or not
boolean repeatSolve=0;     //whether solve repeat or not
boolean newRepeatSolve=0;  // whether solve repeat using new stragegy
...
unsigned int *edgesInReadPaths= NULL;
long long cvgAvg4Edge = 0;
long long cvgAvg4NoneCvg1Edge = 0;
