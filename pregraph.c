...
void initenv ( int argc, char ** argv )
{
	...
	while ( ( copt = getopt ( argc, argv, "a:s:o:K:p:d:RY" ) ) != EOF )
	{
		//printf("get option\n");
		switch ( copt )
		{
...
//	fprintf ( stderr, "  -Y (optional)    output extra information for resolving repeats with new stragegy in contig step, [NO]\n" );
